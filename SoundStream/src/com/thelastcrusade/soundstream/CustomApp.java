...
@ReportsCrashes(formKey = "", formUri = "https://thelastcrusade.cloudant.com/acra-soundstream/_design/acra-storage/_update/report", reportType = org.acra.sender.HttpSender.Type.JSON, httpMethod = org.acra.sender.HttpSender.Method.PUT,
// Your usual ACRA configuration
mode = ReportingInteractionMode.DIALOG, resDialogText = R.string.crash_dialog_text, resDialogTitle = R.string.crash_dialog_title, resDialogCommentPrompt = R.string.crash_dialog_comment_prompt, resDialogOkToast = R.string.crash_dialog_ok_toast)
public class CustomApp extends Application {
    ...
    public void createServiceLocators() {
        // All of these services should exist for the lifetime of the
        // application
        // bind them here so that you can quickly bind to them in the fragments
        connectionServiceLocator = new ServiceLocator<ConnectionService>(this,
                ConnectionService.class,
                ConnectionService.ConnectionServiceBinder.class);

        messagingServiceLocator = new ServiceLocator<MessagingService>(this,
                MessagingService.class,
                MessagingService.MessagingServiceBinder.class);

        musicLibraryLocator = new ServiceLocator<MusicLibraryService>(this,
                MusicLibraryService.class,
                MusicLibraryService.MusicLibraryServiceBinder.class);

        playlistServiceLocator = new ServiceLocator<PlaylistService>(this,
                PlaylistService.class,
                PlaylistService.PlaylistServiceBinder.class);

        transferServiceLocator = new ServiceLocator<TransferService>(this,
                TransferService.class,
                TransferService.TransferServiceBinder.class);

        userListServiceLocator = new ServiceLocator<UserListService>(this,
